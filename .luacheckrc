...
globals =
{
    ...
    '_STAGE',
    'require',
    -- data_stages.lua 注册的全局函数（依赖 control.lua 加载顺序）
    'is_game_modded',
    'is_mod_loaded'
}
            ...
            fields =
            {
                ...
                inventory =
                {
                    fields =
                    {
                        ...
                        'furnace_source', --deprecated
                        'furnace_result', --deprecated
                        'furnace_modules', --deprecated
                        'furnace_trash', --deprecated
                        'character_main',
                        'character_guns',
                        'character_ammo',
                        'character_armor',
                        ...
                        'robot_cargo',
                        'robot_repair',
                        'assembling_machine_input', --deprecated
                        'assembling_machine_output', --deprecated
                        'assembling_machine_modules', --deprecated
                        'assembling_machine_dump', --deprecated
                        'assembling_machine_trash', --deprecated
                        'lab_input',
                        'lab_modules',
                        ...
                        'rocket_silo_rocket',
                        'rocket_silo_trash',
                        'rocket_silo_input', --deprecated
                        'rocket_silo_output', --deprecated
                        'rocket_silo_modules', --deprecated
                        'cargo_unit',
                        'car_trunk',
                        'car_ammo',
                        'car_trash',
