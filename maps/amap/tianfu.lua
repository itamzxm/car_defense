...
-- 职业分类表 + 图标映射表（已抽离至 tianfu_data.lua）
local TianfuData = require 'maps.amap.tianfu_data'
local tianfu_categories = TianfuData.tianfu_categories
local tianfu_icons = TianfuData.tianfu_icons
...
-- 原 testzhiye / check_missing_skills 调试命令已删除（纯开发期校验用，无运行时依赖）
