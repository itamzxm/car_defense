...
Data.time_skills = {
    ...
    ['yuxunqi'] = {
        time = 60 * 60 * 10 -- 每10分钟收网一次（原误填60*10=10秒，快60倍）
    },
    ['chezaiduannpeng'] = {
        time = 60 * 60 * 3 -- 每3分钟收获一次（原误填60*3=3秒，快60倍）
    },
    ['qianchuanguihai'] = {
        time = 60 * 25 -- 调度下限25秒；实际间隔按品质逐档 {60,50,40,32,25} 秒自门控
    },
    ['tianshitouzi'] = {
        time = 60 * 60 -- 每分钟资助一次（原误填60=1秒，快60倍）
    },
    ['xiechoubaoku'] = {
        time = 60 * 60 * 10 -- 每10分钟结息一次（原误填60*10=10秒，快60倍）
    },
    ['shifutilian'] = {
        time = 60 * 10 -- 每10秒提炼一次
    },
