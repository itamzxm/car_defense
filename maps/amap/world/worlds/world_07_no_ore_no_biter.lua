...
World.register(7, {
    ...
    -- 已禁用：从随机选世界池与投票界面排除（其世界加成已转移到世界16「平凡之日」）
    selectable = false,
    ...
    --==========================================================================
    -- 通关奖励（已禁用：加成已转移到世界16「平凡之日」）
    --==========================================================================
    -- 原通关奖励类型（character_running_speed_bonus 移动速度加成）已搬到世界16
    world_bonus_type = nil,
    -- 原 joins_solar_system_edge=true 已转移到世界16（避免禁用后卡住终极奖励）
