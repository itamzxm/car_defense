...
local function create_map_intro(data)
    ...
    -- 使用正确的本地化字符串格式：{'模块名.键名'}
    local caption = map_info.main_caption or {'amap.map_info_main_caption'}
    local sub_caption = map_info.sub_caption or {'amap.map_info_sub_caption'}
    local text = map_info.text or {'amap.map_info_text'}
    ...
    local l_2 = t.add {type = 'label', caption = sub_caption}
    ...
    scroll_pane.style.maximal_width = 780
