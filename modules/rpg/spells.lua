...
-- ============================================
-- 技能数据 / 升级参数 / 投射物类型（已抽离至 spells_data.lua）
-- ============================================
local SpellsData = require 'modules.rpg.spells_data'

function Public.conjure_items()
    return SpellsData.spells
end
Public.itam_spell = SpellsData.itam_spell
Public.projectile_types = SpellsData.projectile_types
