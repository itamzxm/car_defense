...
f.draw_noise_tile_ring = function(surface, position, name, radius_min, radius_max)
    local modifier_1 = math.random(2, 5) * 0.01
...
f.draw_rainbow_patch = function(position, surface, radius, richness)
    ...
    local modifier_1 = math.random(3, 7)
    local modifier_2 = math.random(1, 10) * 0.005
    local modifier_3 = math.random(1, 10) * 0.05
    local modifier_4 = math.random(5, 30) * 0.01
    local seed = game.surfaces[1].map_gen_settings.seed
